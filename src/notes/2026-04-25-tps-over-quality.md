...
I had to rely on Gemini 3 Flash. Turns out, it has no right to be as good as it is for repeated tasks (skills) or refactoring. Insanely good model, but the best thing is the speed.
...
{% image "./src/static/img/vibes/verification-expiring.png", "Sad Pepe", "w-full rounded-lg shadow-md border border-surface-border" %}
