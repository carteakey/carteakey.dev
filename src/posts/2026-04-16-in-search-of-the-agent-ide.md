...
|------|----------|-------------|----------------|--------------|--------|------------|----------------|
| **VS Code** | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} via extensions | {% feather "alert-triangle", class="table-icon table-icon-warn" %} multi-root is clunky | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} | No | Too much window switching. Three workspaces and nothing is where I left it. |
| **Warp** | {% feather "check", class="table-icon table-icon-check" %} | {% feather "alert-triangle", class="table-icon table-icon-warn" %} some AI | {% feather "check", class="table-icon table-icon-check" %} blocks + panes | {% feather "alert-triangle", class="table-icon table-icon-warn" %} basic | {% feather "x", class="table-icon table-icon-no" %} terminal only | No | Heavy. Requires login. No thanks. |
| **Cursor / Windsurf** | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} | No | Great for devs. For my workflows it felt like wearing a suit to go for a walk. |
| **Claude Code Desktop** | {% feather "check", class="table-icon table-icon-check" %} | {% feather "x", class="table-icon table-icon-no" %} account-only | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} diff review | Yes, automatic | No API-key support. Dead on arrival for me. |
| **Superset** | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} via CC CLI | {% feather "check", class="table-icon table-icon-check" %} parallel agents | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} review/merge | Yes, core model | Built for ten agents in parallel. I want one workspace, not a factory. |
| **Conductor** | {% feather "check", class="table-icon table-icon-check" %} | {% feather "alert-triangle", class="table-icon table-icon-warn" %} limited | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} strong PR flow | Yes, very | Same shape as Superset. Worktree-first, I'm worktree-last. |
| **cmux** | {% feather "check", class="table-icon table-icon-check" %} | {% feather "alert-triangle", class="table-icon table-icon-warn" %} unclear | {% feather "check", class="table-icon table-icon-check" %} | terminal-centric | terminal | Optional | macOS-native, interesting - but the file/Git story wasn't there. |
| **Wave Terminal** | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} native | {% feather "check", class="table-icon table-icon-check" %} panes + blocks | {% feather "check", class="table-icon table-icon-check" %} preview + edit | {% feather "alert-triangle", class="table-icon table-icon-warn" %} add lazygit | No | Best prebuilt option I found. Still in the game. |
| **Ghostty + CC CLI + Yazi + lazygit** | {% feather "x", class="table-icon table-icon-no" %} modular | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} tabs + tmux | {% feather "check", class="table-icon table-icon-check" %} Yazi is excellent | {% feather "check", class="table-icon table-icon-check" %} lazygit is great | No | Still in the game. Assembled it myself, somewhat against my will. |
| **Zed** | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} | {% feather "alert-triangle", class="table-icon table-icon-warn" %} improving | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} | No | Multi-workspace still evolving. Promising, not there. |
| **JetBrains Fleet** | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} | {% feather "check", class="table-icon table-icon-check" %} | No | Good workspace concept. Smaller ecosystem, felt heavy for me. |
{% endwide %}
