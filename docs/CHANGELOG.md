...
## [2.6.16] - 2026-09-15
### Changed
- Removed the homepage At a Glance counts sidebar, retaining the original introduction, featured posts beside the site index, and illustrated square activity cards with existing pin ordering.
...
- Internationalization: Added opt-in language metadata and alternate-link infrastructure; the Hindi proof page remains available in source for a future translation pass.
...
- Internationalization: Temporarily disabled the Hindi proof page and language switcher until fuller translated content is ready.
...
### Fixed
- note.njk, tailwind.css: Capped note images so screenshots and inline media do not stretch across the full reading column.
...
## [2.0.28] - 2026-06-21
### Fixed
- netlify.toml: Enable corepack and prepare/activate pnpm@11.5.0 in the build command to prevent permission denied errors during Netlify build.

## [2.0.27] - 2026-06-21
### Fixed
- eleventy.config.mjs, post listing templates, tailwind.css: Generate responsive AVIF/WebP post thumbnails at their rendered sizes instead of downloading full-resolution source images, while preserving the homepage thumbnail layout through the generated picture wrapper.
